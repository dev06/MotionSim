...
//			}
		...
		{
//			userAccountName.color = MergeUserAccount.instance.UserProfileNameColor;
//
//			if (result != "" && MergeUserAccount.instance.conf.showUserProfileName)
//			{
...
//				Debug.LogError("Username set to ACCOUNT.");
//			}
		}

		public void UpdateUserAccountInit()
		{
//			if (MergeUserAccount.instance.conf.userSignInActive)
//			{
//				AddMenuElement(userAccountsButton, 5, true);
//			}
//			else
//			{
//				RemoveMenuElement(userAccountsButton);
//			}
		}

		void Initialize()
		{
//			MergeUserAccount.instance.confChangeUpdate += UpdateUserAccountInit;
//			if (MergeUserAccount.instance.conf.userSignInActive)
//			{
//				useMergeUserAccount = true;
//				AddMenuElement(userAccountsButton, 5, true);				
//				userAccountName.color = Color.white;
//
//				MergeUserAccount.instance.pNameUpdate += HandleUserLogin;
...
//				Invoke("FinishHeadsetViewSetup",0.5f);
		...
		void OnApplicationPause(bool pauseStatus)
		{
			if ( !pauseStatus )
			{
				if ( isFlashOn )
				{
					CancelInvoke( "DelayTurnFlashOn" );
					Invoke( "DelayTurnFlashOn", .1f );
				}
			}
		}

		void DelayTurnFlashOn()
		{
			TurnFlashOn();
		}
